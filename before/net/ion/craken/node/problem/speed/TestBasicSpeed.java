...
public class TestBasicSpeed extends TestCase {
	...
	public void testInfinispan() throws Exception {
		...
		dm.defineConfiguration("infinispan", new ConfigurationBuilder().persistence().addSingleFileStore().location("./resource/store/infinispan").clustering().cacheMode(CacheMode.LOCAL).build()) ;
