 ...
 * 
 * By implementing {@link org.jboss.marshalling.ByteOutput} we avoid the need for the byte stream to be wrapped by {@link org.jboss.marshalling.Marshalling#createByteOutput(OutputStream)}
 * 
