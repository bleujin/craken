...
public class GridFilesystem {
	 ...
	 * 
	 * @param data
	 *            the cache where the actual file contents are stored
	 * @param metadata
	 *            the cache where file meta-data is stored
	 ...
	 *            the full path of the requested file
	 * @param chunkSize
	 *            the size of the file's chunks. This parameter is only used for non-existing files.
	 * @return the File stored at pathname
	 */
	 ...
	 *            the path to write to
	 * @param append
	 *            if true, the bytes written to the OutputStream will be appended to the end of the file. If false, the bytes will overwrite the original contents.
	 * @return an OutputStream for writing to the file at pathname
	 * @throws IOException
	 *             if an error occurs
	 */
	 ...
	 * @param chunkSize
	 *            the size of the file's chunks. This parameter is honored only when the file at pathname does not yet exist. If the file already exists, the file's own chunkSize has precedence.
	 ...
	 *            the path to write to
	 * @param append
	 *            if true, the bytes written to the WritableGridFileChannel will be appended to the end of the file. If false, the bytes will overwrite the original contents.
	 * @return a WritableGridFileChannel for writing to the file at pathname
	 * @throws IOException
	 *             if an error occurs
	 */
