...
/**
 * A TreeNode is a {@link Fqn named} logical grouping of data in the {@link TreeCache} API of JBoss {@link Cache}. A node should be used to contain data for a single data record, for example information about a particular person or account.
 * <p/>
...
public interface TreeNode<K, V> {
	...
	/**
	 * Returns a map containing the data in this {@link TreeNode}.
	 * 
	 * @return a {@link Map} containing the data in this {@link TreeNode}. If there is no data, an empty {@link Map} is returned. The {@link Map} returned is always immutable.
	 */
	Map<K, V> getData();
	...
	/**
	 * Returns a {@link Set} containing the data in this {@link TreeNode}.
	 * 
	 * @return a {@link Set} containing the data in this {@link TreeNode}. If there is no data, an empty {@link Set} is returned. The {@link Set} returned is always immutable.
	 */
	Set<K> getKeys();
	...
	/**
	 * Returns the {@link Fqn} which represents the location of this {@link TreeNode} in the cache structure. The {@link Fqn} returned is absolute.
	 * 
	 * @return The {@link Fqn} which represents the location of this {@link TreeNode} in the cache structure. The {@link Fqn} returned is absolute.
	 */
	Fqn getFqn();
	 ...
	 * 
	 * @param f
	 *            {@link Fqn} of the child node, relative to the current node.
	 ...
	 * 
	 * @param f
	 *            {@link Fqn} relative to the current node of the child you are testing the existence of.
	...
	Set<Fqn> getChildrenFqn();

	Set<Fqn> getReferencesFqn(String refName);
