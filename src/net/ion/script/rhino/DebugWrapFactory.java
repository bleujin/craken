...
public class DebugWrapFactory extends WrapFactory {
	@Override
...
class InterceptNativeObject extends NativeJavaObject {
	...
	private static final long serialVersionUID = -4503391535320884931L;
	...
	public InterceptNativeObject(Scriptable scope, Object javaObject, Class<?> staticType) {
