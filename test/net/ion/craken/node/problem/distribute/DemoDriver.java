 ...
 * 
 * As always when running JGroups to run a demo cluster of multiple applications running on the same host, set these JVM options: -Djava.net.preferIPv4Stack=true -Djgroups.bind_addr=127.0.0.1
 * 
...
public class DemoDriver implements Runnable {
	...
	public static void main(String[] args) throws IOException {
		DefaultCacheManager cacheManager = new DefaultCacheManager("resource/config/lucene-demo-cache-config.xml");
		cacheManager.start();
		try {
