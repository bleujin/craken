...
public class Providers {
	 ...
	 * 
	 */
	public static Iterable<String> getSupportedProvidersOfType(@SuppressWarnings("rawtypes") Class<? extends RestContextBuilder> type) {
	...
	public static Iterable<String> getSupportedProvidersOfTypeInProperties(@SuppressWarnings("rawtypes") final Class<? extends RestContextBuilder> type, final Properties properties) {
	...
	public static <S, A> Class<RestContextBuilder<S, A>> resolveContextBuilderClass(String provider, Properties properties) throws ClassNotFoundException, IllegalArgumentException, SecurityException, InstantiationException, IllegalAccessException, InvocationTargetException, NoSuchMethodException {
		...
		if ("aws-s3".equals(provider)){
			syncClassName = "org.jclouds.aws.s3.AWSS3Client" ;
			asyncClassName = "org.jclouds.aws.s3.AWSS3AsyncClient" ;
		}
		...
		if (syncClassName != null) {
			...
			return (Class<RestContextBuilder<S, A>>) (contextBuilderClassName != null ? Class.forName(contextBuilderClassName) : RestContextBuilder.class);
		} else {
	...
	public static <S, A> RestContextBuilder<S, A> initContextBuilder(Class<RestContextBuilder<S, A>> contextBuilderClass, @Nullable Class<S> sync, @Nullable Class<A> async, Properties properties) throws ClassNotFoundException, IllegalArgumentException, SecurityException, InstantiationException,
		...
		try {
			...
			return (RestContextBuilder<S, A>) contextBuilderClass.getConstructor(sync.getClass(), async.getClass(), Properties.class).newInstance(sync, async, properties);
		}
	}
